...
Answer : We can call consctractor in Baseclass to solve redundancy.
3. What happen if you uncomment line #27-28 in the Program.cs file? Why?
Answer : Error, Abstract can't have constructor.
...
Answer : Add printPerimeter in Main class but not in Main method so the the program will display the result.
