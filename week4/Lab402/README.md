...
Answer :We can call constractor in baseclass for solve redundancy.
3. What happen if you uncomment line #27-28 in the Program.cs file? Why?
Answer : Error, because abstract class cant have constructor.
4. If you uncomment line #30-24 in the Program.cs file, you will get some compile errors.
   ...
   Answer :Add and use printPerimeter method in mainclass but outside main method for show perimeter.
