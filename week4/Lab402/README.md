...
1. Are there still any redundant lines of code in your project? where? no
2. Modify the project so that you can minimize or solve those redundancy. -
3. What happen if you uncomment line #27-28 in the Program.cs file? Why? error because it's a abstract class.
4. If you uncomment line #30-24 in the Program.cs file, you will get some compile errors.
   ...
   the program will display the result as shown below: finished
